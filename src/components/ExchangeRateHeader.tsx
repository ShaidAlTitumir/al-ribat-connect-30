...
const ExchangeRateHeader = ({ title }: ExchangeRateHeaderProps) => {
  ...
  return (
    <header className="h-12 border-b border-border bg-card sticky top-16 lg:top-0 z-20 px-4 lg:px-8 flex items-center justify-between -mt-px pt-px">
      <h2 className="text-sm lg:text-lg font-bold text-foreground truncate">{title}</h2>
