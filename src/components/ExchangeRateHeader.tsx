...
const ExchangeRateHeader = ({ title }: ExchangeRateHeaderProps) => {
  ...
  return (
    <header className="h-[4.5rem] border-b border-border bg-card/80 backdrop-blur-md sticky top-[4.5rem] lg:top-0 z-10 px-4 lg:px-8 flex items-center justify-between transition-all duration-200">
