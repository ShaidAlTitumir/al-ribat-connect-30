  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <main ref={mainRef} className="flex-1 lg:ml-64 flex flex-col overflow-y-auto min-w-0">
        {/* Mobile top bar */}
        <div className="sticky top-0 z-30 lg:hidden flex items-center justify-between h-16 px-4 bg-card/95 backdrop-blur-md border-b border-border">
          <div className="flex items-center gap-3 min-w-0">
            <button
              onClick={() => setSidebarOpen(true)}
              className="flex items-center justify-center w-11 h-11 rounded-lg hover:bg-muted transition-all duration-200 active:scale-95 shrink-0"
            >
